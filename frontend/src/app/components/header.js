                        ...
                        <div className="row">
                            <div className="col-xl-6 col-lg-8">
                                <ul className="tg-header__top-info left-side list-wrap">
                                    <li><i className="flaticon-placeholder"></i>Thành Phố Hồ Chí Minh</li>
                                    <li><i className="flaticon-mail"></i><Link href="mailto:Petspostinfo@gmail.com">petsisters.80833@gmail.com</Link></li>
                                    <li>
                                    <i className="flaticon-user"></i>
                                        {customer ? `Xin chào ${customer.full_name}` : 'Xin chào Quý Khách'}
                                    </li>
                                </ul>
                            </div>
                            <div className="col-xl-6 col-lg-4">
                                <ul className="tg-header__top-right list-wrap">
                                    <li><i className="flaticon-three-o-clock-clock"></i>Giờ mở cửa: 09.00 am- 11.00 pm</li>
                                    ...
                                    <nav className="tgmenu__nav">
                                        ...
                                        <div className="tgmenu__navbar-wrap tgmenu__main-menu d-none d-lg-flex">
                                            <ul className="navigation">
                                                <li className="active "><Link href="/">Trang chủ</Link>
                                                ...
                                                <li><Link href={"/thong-tin"}>Thông Tin</Link></li>
                                                <li className="menu-item-has-children"><Link href="/cua-hang">Cửa Hàng</Link>
                                                    <ul className="sub-menu">
                                        ...
                                        <div className="tgmenu__action d-none d-md-block">
                                            <ul className="list-wrap">
                                                ...
                                                {customer ? (<li className="header-btn"><button onClick={hanldelogout} type='submit' className="btn"><i className="flaticon-user"></i>                                                    Đăng Xuất</button></li>)
                                                    :
                                                    (<li className="header-btn"><Link href={"/dang-nhap"} className="btn"><i className="flaticon-user"></i>đăng nhập</Link></li>)
                                                }
                                            </ul>
                                        </div>
