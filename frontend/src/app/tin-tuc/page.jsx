                        ...
                        <div className="row">
                            <div className="col-xl-9 col-lg-8 order-0 order-lg-2">
                                            ...
                                            <div className="blog__post-item-three blog__post-item-five shine-animate-item">
                                                <div className="blog__post-thumb-three blog__post-thumb-five shine-animate">
                                                    ...
                                                    <ul className="list-wrap blog__post-tag blog__post-tag-two">
                                                        <li><Link href="blog.html">{post.tags}</Link></li>
                                                    </ul>
                                                </div>
                                                <div className="blog__post-content-three">
                                                    ...
                                                    <h2 className="title"><Link href="blog-details.html">{post.title}</Link></h2>
                                                    <p dangerouslySetInnerHTML={{ __html: truncateContent(post.content, 150) }}></p> {/* Cắt bớt nội dung HTML */}
                                                    <Link href={`chi-tiet-tin-tuc/${post.slugs}`} className="btn">Xem Thêm<img src="img/icon/right_arrow.svg" alt="" className="injectable" /></Link>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                                ...
                                <nav className="pagination__wrap mt-50">
                                    <ul className="list-wrap">
                                        <li className="link-arrow"><Link href="#"><img src="img/icon/pagination_icon01.svg" alt="" className="injectable" /></Link></li>
                                        <li className="active"><Link href="#">1</Link></li>
                                        <li><Link href="courses.html">2</Link></li>
                                        <li><Link href="courses.html">3</Link></li>
                                        <li><Link href="courses.html">4</Link></li>
                                        <li className="link-arrow"><Link href="#"><img src="img/icon/pagination_icon02.svg" alt="" className="injectable" /></Link></li>
                                    </ul>
                                </nav>
                            </div>
                                ...
                                <aside className="blog-sidebar">
                                        ...
                                        <div className="rc-post-wrap">
                                            {dataPost.map((post) => (
                                                <div className="rc-post-item" key={post.id}>
                                                    <div className="thumb">
                                                        <Link href={`chi-tiet-tin-tuc/${post.slugs}`}><img src={`${post.image}`} alt="img" /></Link>
                                                    </div>
                                                    <div className="content">
                                                        <h4 className="title"><Link href={`chi-tiet-tin-tuc/${post.slugs}`}>{post.title}</Link></h4>
                                                        <span className="date"><i className="flaticon-calendar"></i>{moment(post.created_at).format("DD/MM/YYYY")}</span>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                                    ...
                                    <div className="blog-widget">
                                        ...
                                        <div className="sidebar-tag-list">
                                            <ul className="list-wrap">
                                                {dataPost.map((post) => (
                                                    <li><Link href="#" key={post.id}>{post.tags}</Link></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
